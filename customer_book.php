...
<div class="container-fluid">
	<form id="manage_book">
		<div class="col-md-12">
			...
			<!-- cnum -->
			<div class="form-group mb-2">
				<label for="cnum" class="control-label">Contact Number:</label>
				<input type="int" class="form-control" id="cnum" name="cnum" value="<?php echo isset($bmeta['cnum']) ? $bmeta['cnum'] : '' ?>">
			</div>
			<div class="form-group mb-2">
		...
		$.ajax({
			...
			success:function(resp){
				...
				if(resp.status == 1){
    				...
    				$('#book_modal .modal-body').html('<div class="text-center"><p>Your seat reservation has been made. Thank You. <br><strong><h3>'+resp.ref+'</h3></strong></p><small>Reference Number</small><br/><small>Copy or Capture your Reference number to proceed and print your ticket.</small> </br></br><a href = "payment.php"><button type="button" class="btn btn-primary" id="print_ticket">Pay & Print your ticket here</button></a></div>')

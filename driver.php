...
<div class="container-fluid">
		<div class="col-lg-12">
			...
			<div class="row">
				<div class="col-md-12">
					<button class="float-right btn btn-success btn-md" type="button" id="new_driver">Add New <i class="fa fa-plus"></i></button>
				</div>
			</div>
		<?php endif; ?>
			<div class="row">
			...
			<div class="row">
				<div class="card col-md-12">
					<div class="card-header">
						<div class="card-title"><b>Driver List</b></div>
					</div>
					<div class="card-body">
...
<script>
	$('#new_driver').click(function(){
		uni_modal('Add New Driver','manage_location.php')
	})
						...
						resp = JSON.parse(resp)
							if(Object.keys(resp).length > 0){
								...
								Object.keys(resp).map(k=>{
									...
									tr.append('<td class="text-center">'+resp[k].city+'</td>')
